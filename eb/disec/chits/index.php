...
function roll(){
    ...
    $sql = "SELECT started FROM chits WHERE committee LIKE 'UNGA-DISEC'";
    $a=$link->query($sql);
    $r=$a->fetch_assoc();
...
if(isset($_POST['chit1'])){$link->query("INSERT INTO chits(committee,started) VALUES ('UNGA-DISEC','yes')");header('Location:/eb/disec/chits');}
else if(isset($_POST['chit2'])){$link->query("DELETE FROM chits WHERE committee LIKE 'UNGA-DISEC'");header('Location:/eb/disec/chits');}
?>
<!doctype html>
