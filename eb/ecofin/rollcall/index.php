...
$link = new mysqli("localhost","u864523831_cvmun20","ChettinadVidyashram600028","u864523831_cvmun20");
$sql = "SELECT * FROM `UNGA-ECOFIN` WHERE rollcall NOT LIKE ''";
...
if(isset($_POST['rollcall1'])){$link->query("INSERT INTO rollcall(committee,started) VALUES ('UNGA-ECOFIN','yes')");header('Location:/eb/ecofin/rollcall');}
?>
<!doctype html>
