...
$link = new mysqli("localhost","u864523831_cvmun20","ChettinadVidyashram600028","u864523831_cvmun20");
$sql = "SELECT * FROM `UNGA-DISEC` WHERE rollcall NOT LIKE ''";
...
if(isset($_POST['rollcall1'])){$link->query("INSERT INTO rollcall(committee,started) VALUES ('UNGA-DISEC','yes')");header('Location:/eb/disec/rollcall');}
?>
<!doctype html>
