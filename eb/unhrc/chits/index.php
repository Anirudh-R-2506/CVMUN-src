...
function roll(){
    ...
    $sql = "SELECT started FROM chits WHERE committee LIKE 'UNHRC'";
    $a=$link->query($sql);
    $r=$a->fetch_assoc();
...
if(isset($_POST['chit1'])){$link->query("INSERT INTO chits(committee,started) VALUES ('UNHRC','yes')");header('Location:/eb/unhrc/chits');}
else if(isset($_POST['chit2'])){$link->query("DELETE FROM chits WHERE committee LIKE 'UNHRC'");header('Location:/eb/unhrc/chits');}
?>
<!doctype html>
