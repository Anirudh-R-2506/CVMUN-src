...
function roll(){
    ...
    $sql = "SELECT started FROM rollcall WHERE committee LIKE 'UNHRC'";
    $a=$link->query($sql);
    $r=$a->fetch_assoc();
...
if(isset($_POST['submit'])){
    ...
    $totalt=$_POST['total'];
    $link = new mysqli("localhost","u864523831_cvmun20","ChettinadVidyashram600028","u864523831_cvmun20");
    $link->query("DELETE FROM `ebvUNHRC`");
    $sql = "INSERT INTO `ebvUNHRC`(motion,name,type,minutes,totalt) VALUES('$motion','$name','$type','$minutes','$totalt')";
    $link->query($sql);
    $link->query("DELETE FROM `vUNHRC`");
    header('Location:/eb/unhrc/vote/');
}
if(isset($_POST['submit2'])){$link->query("UPDATE `ebvUNHRC` SET `end`='yes'");header('Location:/eb/unhrc/vote/');}
?>
<!doctype html>
...
<body>
  ...
  <div class="preloader"></div>
	...
	<center>
    <a href="/eb/unhrc/" style="color:white" class="boxed-btn3 wow fadeInDown" data-wow-duration="1s" data-wow-delay=".3s">MAIN MENU</a></center>
	<script>
