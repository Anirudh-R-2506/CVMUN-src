...
$link = new mysqli("localhost","u864523831_cvmun20","ChettinadVidyashram600028","u864523831_cvmun20");
$sql = "SELECT * FROM `UNHRC` WHERE rollcall NOT LIKE ''";
...
if(isset($_POST['rollcall1'])){$link->query("INSERT INTO rollcall(committee,started) VALUES ('UNHRC','yes')");header('Location:/eb/unhrc/rollcall');}
?>
<!doctype html>
