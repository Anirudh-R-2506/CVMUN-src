<?php 
	...
	if(isset($_POST['post'])) {
		...
		$data = [
			'secret' => "6LeKuekUAAAAAIFBziNqp-Xkx4ZOH3GnRaD75Ueg",
...
<html>
  <head>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LeKuekUAAAAALdbBW_IoDpztFA7y5lKN4SSxOaa"></script>
	...
	<div class="container">
	    ...
	    <div class="card">
		  	...
		  	<div class="card-body px-lg-5 pt-0">
	            ...
	            <input type="hidden" id="a" onclick="my()">
	        	</form>
			</div>
		</div>
	</div>
  ...
  grecaptcha.ready(function() {
      grecaptcha.execute('6LeKuekUAAAAALdbBW_IoDpztFA7y5lKN4SSxOaa', {action: 'homepage'}).then(function(token) {
         // console.log(token);
         document.getElementById("token").value = token;
      });
  });
  function my(){
      alert('hidden is clicked..');
  }
  </script>
